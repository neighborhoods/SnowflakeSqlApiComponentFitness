...
namespace Neighborhoods\SnowflakeSqlApiComponentFitness\ClientV1\DataTypes;
...
class Worker
{
    ...
    public function buildRequestWithManyDataTypes(): ClientV1\StatementsRequestInterface
    {
        ...
        $body = $this->getClientV1StatementsRequestBodyFactory()
            ->create()
            ->setStatement("select ? as int_value,
                ? as real_value,
                ? as bool_value,
                ? as text_value,
                ? as null_value,
            ...
            ->setBindings(
                ...
                ->create()
                ->setValues([1, 1.2, true, 'text', null, new DateTimeImmutable()])
                ->build()
            );
